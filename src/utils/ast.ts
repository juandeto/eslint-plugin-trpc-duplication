 ...
 */
export function isTrpcHookCall(
  node: TSESTree.CallExpression,
): { router: string; procedure: string } | null {
 ...
 */
export function isTrpcServerCall(
  node: TSESTree.CallExpression,
): { router: string; procedure: string } | null {
 ...
 */
export function formatProcedureKey(router: string, procedure: string): string {
